    ...
    >
      ...
      <div className="p-4">
        ...
        {(product.controlledSubstance || product.needsRecipe) && (
          <div className="flex items-center gap-1.5 mb-3 bg-purple-50 border border-purple-200 rounded-lg px-3 py-2">
            ...
            <span className="text-purple-800 text-xs font-black leading-tight" style={H9}>
              ...
              <br />
              <span className="font-semibold text-purple-600">Requiere récipe</span>
            </span>
          </div>
        )}
