...
// ─── Types ───────────────────────────────────────────────────────────────────
export type Page = "home" | "catalog" | "product" | "cart" | "preCheckout" | "checkout" | "tracking" | "favorites" | "login" | "banners" | "profile" | "delivery" | "admin" | "notifications";
...
export const DEFAULT_SLIDES: Slide[] = [
  ...
  { title: "Vitaminas & Suplementos", subtitle: "Refuerza tu sistema inmune con los mejores suplementos. Entrega rápida en Ciudad Guayana.", badge: "DESTACADOS", from: "#031b24", via: "#00546a", to: "#50e9f8", img: "https://images.unsplash.com/photo-1550572017-efe56097ef4a?w=900&h=500&fit=crop&auto=format", cta: "Explorar Vitaminas →" },
